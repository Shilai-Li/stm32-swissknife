 ...
 * @details Provides a RingBuffer interface for USB CDC (Virtual COM Port).
 *          Makes USB usage as simple as UART.
 * @note    Requires CubeMX generated "USB Device" -> "Communication Device Class (VCP)".
 */
