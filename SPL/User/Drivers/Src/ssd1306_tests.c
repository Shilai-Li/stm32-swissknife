...
static void Test_Delay(uint32_t ms) {
    ...
    for (i = 0; i < ms; i++) {
        for (j = 0; j < 7200; j++) { // Adjust based on clock speed
            __NOP();
        }
    }
}
...
void ssd1306_TestFPS() {
    ...
    // Run for 100 iterations instead of time
    for(int i = 0; i < 100; i++) {
    ...
    snprintf(buff, sizeof(buff), "~%d Frames", fps);
...
void ssd1306_TestAll() {
    ...
    UART_Debug_Printf("ssd1306_TestAll\r\n");

    ssd1306_TestFPS();
    // UART_Debug_Printf("ssd1306_TestFPS\r\n");
    Test_Delay(3000);
    ssd1306_TestBorder();
    ssd1306_TestFonts1();
    // UART_Debug_Printf("ssd1306_TestFonts1\r\n");
    Test_Delay(3000);
    ssd1306_TestFonts2();
    // UART_Debug_Printf("ssd1306_TestFonts2\r\n");
    Test_Delay(3000);
    ssd1306_TestFonts3();
    // UART_Debug_Printf("ssd1306_TestFonts3\r\n");
    Test_Delay(3000);
    ssd1306_Fill(Black);
    ssd1306_TestRectangle();
    // UART_Debug_Printf("ssd1306_TestRectangle\r\n");
    Test_Delay(3000);
    ssd1306_TestLine();
    // UART_Debug_Printf("ssd1306_TestLine\r\n");
    Test_Delay(3000);
    ssd1306_Fill(Black);
    ssd1306_TestRectangleFill();
    // UART_Debug_Printf("ssd1306_TestRectangleFill\r\n");
    Test_Delay(3000);
    ssd1306_Fill(Black);
